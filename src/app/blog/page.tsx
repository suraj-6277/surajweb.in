          ...
          return (
            ...
            >
              ...
              >
                <div className="flex flex-col p-3 w-full">
                  ...
                  <div className="flex gap-3 items-center">
                    <div className=" w-full">
                      <p className="font-medium text-lg transition-colors duration-300 group-hover:text-[#0F172A]">
                        {post.title}
                      </p> 
                ...
                >
                  <div className="font-medium text-sm flex gap-1 items-center pt-4 pl-3 text-subtle transition-colors duration-300 group-hover:!text-[#0F172A]">
